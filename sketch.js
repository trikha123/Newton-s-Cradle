...
function setup() {
  ...
  rope1 = new Rope(bob1.body, ground1.body, 10, 0)
  rope2 = new Rope(bob2.body, ground1.body, 20,0)
	rope3 = new Rope(bob3.body,ground1.body, 30,0)
  rope4 = new Rope(bob4.body,ground1.body, 40,0)
  rope5 = new Rope(bob5.body,ground1.body, 50,0)
